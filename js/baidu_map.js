...
for (i = 0; i < stus.length; i++) {
    if (stus[i].hasOwnProperty('poi')) {
        grad_info = ' <div style="text-align: center;float: left; margin: 1%;font-size: 0.7vw;"><img src="' + stus[i].pic + '" style="width: 60px; height: 90px;"><div>' + stus[i].name + '<br>' + stus[i].gdt + '届' + stuType[stus[i].type] + '<br>' + stus[i].offer + '</div></div>';
